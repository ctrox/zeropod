...
type ContainerMetrics struct {
	...
	DryRunRestores         int64                  `protobuf:"varint,12,opt,name=dry_run_restores,json=dryRunRestores,proto3" json:"dry_run_restores,omitempty"`
...
const file_shim_proto_rawDesc = "" +
	...
	"\adry_run\x18\t \x01(\bR\x06dryRun\"\xe8\x04\n" +
	...
	"\x13dry_run_scale_downs\x18\v \x01(\x03R\x10dryRunScaleDowns\x12(\n" +
	"\x10dry_run_restores\x18\f \x01(\x03R\x0edryRunRestores\x12\x17\n" +
	"\adry_run\x18\r \x01(\bR\x06dryRun*g\n" +
