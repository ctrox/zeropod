...
# HELP zeropod_dry_run_restores_total Total number of simulated dry-run restores.
# TYPE zeropod_dry_run_restores_total counter
zeropod_dry_run_restores_total{container="nginx",namespace="default",pod="nginx"} 0
```
