...
func registerTaskService(name string, srv *ttrpc.Server, svc taskAPI.TTRPCTaskService) {
	srv.RegisterService(name, &ttrpc.ServiceDesc{
		Methods: map[string]ttrpc.Method{
			...
			"Pids": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Pause": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Resume": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Kill": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Exec": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"ResizePty": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"CloseIO": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Stats": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Connect": func(ctx context.Context, unmarshal func(any) error) (any, error) {
			...
			"Shutdown": func(ctx context.Context, unmarshal func(any) error) (any, error) {
